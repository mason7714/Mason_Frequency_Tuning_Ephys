classdef Session < handle
    ...
    methods
        ...
        function add_Cluster(obj,varargin)
            ...
            cid_str = string(cid);
existingIDs_str = string(existingIDs);

assert(~any(existingIDs_str == cid_str), ...
    'epa:Session:add_Cluster:IDexists', ...
    'Cluster %s already exists for this Session object', cid_str);
