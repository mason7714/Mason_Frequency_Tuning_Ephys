%% Frequency tuning analysis across ALL concat folders for one subject
tic

clear S D

% subjectPath = '/mnt/CL_8TB_4/Mason/Ephys/DorsalAUD_PL/Sorting/SUBJ-ID-1180'; % SUBJ-ID-1180
% subjectPath = '/mnt/CL_8TB_4/Mason/Ephys/DorsalAUD_PL/Sorting/SUBJ-ID-1168'; % SUBJ-ID-1168
% subjectPath = '/mnt/CL_8TB_4/Mason/Ephys/DorsalAUD_PL/Sorting/SUBJ-ID-1173'; % SUBJ-ID-1173
% subjectPath = '/mnt/CL_8TB_4/Mason/Ephys/DorsalAUD_PL/Sorting/SUBJ-ID-1159'; % SUBJ-ID-1159
subjectPath = '/mnt/CL_8TB_4/Mason/Ephys/DorsalAUD_PL/Sorting/SUBJ-ID-1140'; % SUBJ-ID-1140

concatDirs = dir(fullfile(subjectPath, '*_concat'));
concatDirs = concatDirs([concatDirs.isdir]);

run_freqTuning_analysis(subjectPath)
toc
%%
tic
combine_all_FreqTuning_excel_sheets(subjectPath)
toc
%%
...
% 
% % remove generated/clean EPA files
...
% 
% % keep only original freqTuning trialInfo
% d = d(contains(string({d.name}), freqSessionName) | ...
%       contains(string({d.name}), 'freqTuning'));
% 
% if isempty(d)
%     disp("No ORIGINAL freqTuning trialInfo found. Available trialInfo files:")
%     disp(fullnames')
...
%     warning('Selected trialInfo file does not contain ComputerTimestamp_6: %s. Skipping.', trialInfoFile)
%     continue
% end
% 
...
% 
%     disp(string(E_freq.Name))
%     disp(size(E_freq.OnOffTimes))
%     disp(size(E_freq.Values))
% 
%     disp(string(E_db.Name))
%     disp(size(E_db.OnOffTimes))
%     disp(size(E_db.Values))
% 
%     %% Shared variables
% 
...
% 
%     %% ============================================================
%     %% Heatmaps: raw baseline-subtracted FR
%     %% ============================================================
% 
...
%     end
% 
%     writetable(sound_responsive_table, excelFile, 'Sheet', 'Dprime_raw');
% 
%     %% ============================================================
%     %% D' log1p responsiveness
%     %% ============================================================
% 
...
%     end
% 
%     writetable(sound_responsive_table_log1p, excelFile, 'Sheet', 'Dprime_log1p');
% 
%     %% ============================================================
%     %% Compare raw vs log1p d'
%     %% ============================================================
% 
...
%     end
% 
%     writetable(comparison_table, excelFile, 'Sheet', 'Dprime_comparison');
% 
%     figure(1)
%     clf
...
%     end
% 
%     writetable(BF_table, excelFile, 'Sheet', 'BestFrequency');
% 
%     %% ============================================================
%     %% Bandwidth at 50 percent maximum
%     %% ============================================================
% 
...
%     end
% 
%     writetable(bandwidth_table, excelFile, 'Sheet', 'Bandwidth');
% 
%     %% ============================================================
%     %% Q20 bandwidth using d' >= 1
%     %% ============================================================
% 
%     use_log = true;
%     dprime_criterion = 1;
...
%     end
% 
%     writetable(Q20_table, excelFile, 'Sheet', 'Q20');
% 
...
%% Combine all freqTuning Excel sheets across concat folders
% tic
% % subjectPath = '/mnt/CL_8TB_4/Mason/Ephys/DorsalAUD_PL/Sorting/SUBJ-ID-1180';
% 
% sheetsToCombine = {
%     'Dprime_raw'
%     'Dprime_log1p'
